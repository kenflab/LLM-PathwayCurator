#!/usr/bin/env Rscript
# paper/scripts/figS2_fgsea_to_evidence_table.R
...
if (is.null(script_path) || !nzchar(script_path)) {
  die("Cannot determine script path. Please run via: Rscript paper/scripts/figS2_fgsea_to_evidence_table.R <CANCER> [--collection H] [--subcategory ...]")
}
...
if (length(args) < 1) {
  die("Usage: Rscript paper/scripts/figS2_fgsea_to_evidence_table.R <CANCER> [--collection H] [--subcategory CP:REACTOME] [--out-suffix ...]")
}
