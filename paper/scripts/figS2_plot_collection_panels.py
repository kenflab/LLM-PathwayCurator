#!/usr/bin/env python3
# paper/scripts/figS2_plot_collection_panels.py
...
def main() -> None:
    ...
    plot_panel_A(
        surv,
        out_path=outdir / f"FigS2_PanelA_module_survival.{fmt}",
    ...
    plot_panel_B(
        wide,
        out_path=outdir / f"FigS2_PanelB_module_stats.{fmt}",
        conditions=conditions,
        variants=variants,
        gate_modes=gate_modes,
        taus=taus,
    ...
    plot_panel_C(
        wide,
        out_path=outdir / f"FigS2_PanelC_outcomes.{fmt}",
        conditions=conditions,
        variants=variants,
        gate_modes=gate_modes,
        taus=taus,
    ...
    plot_panel_D(
        reas,
        out_path=outdir / f"FigS2_PanelD_top_reasons.{fmt}",
        conditions=conditions,
        variants=variants,
        gate_modes=gate_modes,
        taus=taus,
